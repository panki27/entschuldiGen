...
excuseList = ["Wegen starken Magenschmerzen konnte ich den Schulunterricht nicht wahrnehmen.",u"Aufgrund von starken Kopfschmerzen war es mir nicht moeglich, den Unterricht zu besuchen.","Da ich derzeit an einer Magendarm-Erkrankung leide, bin ich dem Unterricht fern geblieben.","Aufgrund eines grippalen Infektes musste ich die Schule meiden.","Bedingt durch akute Kopf- und Gliederschmerzen konnte ich den Unterricht nicht besuchen.",u"Wegen eines Zahnarzttermines war es mir nicht moeglich, die Anwesenheit im Unterricht zu erfuellen."]
...
if (frame == "a"):
	print("hiermit entschuldige ich meine Verspaetung im "+ course + " Unterricht am "+ daysOfWeek[dow]+ ', den ' + date + ".")
elif(frame == "e"):
	print("hiermit entschuldige ich mein Fehlen im " + course + " Unterricht am "+ daysOfWeek[dow]+ ', den ' + date + ".")
else:
	#TODO: Wochentag einfuegen
